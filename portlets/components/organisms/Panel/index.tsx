...
export default function Panel(props: PortletComponentProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col items-stretch transition-all @container">
      <header
        className={twMerge(
          "sticky top-0 z-50 shrink-0 bg-background/30 p-4 pb-0 backdrop-blur-md transition-all",
      ...
      <ScrollShadow as="main" className="flex grow flex-col space-y-4 p-4 transition-all">
      ...
      <footer
        className={twMerge(
          "sticky bottom-0 z-50 shrink-0 bg-background/30 p-4 pt-0 backdrop-blur-md transition-all"
        )}
      >
        <Button>Test</Button>
      </footer>
